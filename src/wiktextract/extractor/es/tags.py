...
AMBITO_TAGS = {
    ...
    "Baja Navarra": "Lower Navarre (France)",
    "Bearn": "Bearn (France)",
    "Bearne": "Bearn (France)",
    "Belluno": "Belluno",
    "Bolivia": "Bolivia",
    ...
    "Centro de Chile": "Center of Chile",
    "Centro de México": "Mexico Center",
    ...
    "Labort": "Labort (France)",
    "Languedoc": "Languedoc (France)",
    "Lapurdi": "Labort (France)",
    "León": "León (Spain)",
    "Liechtenstein": "Liechtenstein",
    "Logudoro": "Logudoro",
    "Lunfardo": "Lunfardo",
    "Mallorca": "Mallorca (Balearic Islands)",
    "Marruecos": "Morocco",
    "Matlapa": "Matlapa",
