...
OTHER_GRAMMATICAL_TAGS: dict[str, str] = {
    ...
    "infinitivo (infinitif)": "infinitive",
    "gerúndio (gérondif)": "gerund",
    "particípio (participe)": "participle",
    "formas pessoais\n(formes personnelles)": "personal",
    "singular (singulier)": "singular",
    "plural (pluriel)": "plural",
    "primeira (première)": "first-person",
    "segunda (deuxième)": "second-person",
    "terceira (troisième)": "third-person",
    "infinitivo pessoal\n(infinitif personnel)": ["infinitive", "personal"],
    "modo indicativo (indicatif)": "indicative",
    "presente\n(présent)": "present",
    ...
    "modo subjuntivo (conjuntivo) (mode subjonctif)": "subjunctive",
    "futuro\n(futur)": "future",
    "mode imperativo (impératif)": "imperative",
    "afirmativo\n(affirmatif)": "affirmative",
    "negativo\n(négatif)": "negative",
    "brésilien": "Brazilian",
}
