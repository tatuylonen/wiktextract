TAGS = {
    ...
    "破格": "nonstandard",
    "米語": "US",
    "絶対単数": ["singular", "singular-only"],
    "絶対複数": ["plural", "plural-only"],
    "能格動詞": "ergative",
    "自他動詞": "ambitransitive",
    "自動詞": "intransitive",
    "英連邦": "Commonwealth",
    ...
    "イェール式": "Yale",
    "粤拼": "Jyutping",
    "教院式": ["ILE", "romanization", "Cantonese"],
    "広東拼音方案": "Guangdong-Romanization",
    "台山語": "Taishanese",
    "閩南語": "Min-Nan",
    "漳州": "Zhangzhou",
    "漳浦": "Zhangpu",
    ...
    "命令形": "imperative",
    "命令": "imperative",
    "過去・完了": ["past", "completive"],
    "過去・完了・状態": ["past", "completive"],
    "否定形": "negative",
    "否定": "negative",
    "否定(古風)": ["negative", "archaic"],
    "自動詞化": "intransitive",
    "言い切り": "definitive",
    "名詞化": "noun-from-verb",
    ...
    "複数・主格": "plural",
    "・主格": "nominative",
    "単数対格": ["singular", "accusative"],
    "複数対格": ["plural", "accusative"],
    "属格": "genitive",
    "ラテン文字": "romanization",
    "キリル文字": "Cyrillic",
    # Template:de-noun
