...
xlat_head_map = {
    ...
    # "m or pl": "masculine singular plural",  # XXX information/Eng/Tr/Latga...
    ...
    "f inan or m inan or f inan pl": "feminine masculine inanimate singular plural",
    "f inan or m inan or f inan pl or m inan pl": "feminine masculine inanimate singular plural",
    "m inan pl or m anim pl or f anim pl": "masculine feminine inanimate animate plural",
    "f anim or f inan or f anim pl": "feminine animate inanimate singular plural",
    "f anim or f inan or f anim pl or f inan pl": "feminine animate inanimate singular plural",
    "f anim pl or f inan or f inan pl": "feminine animate inanimate singular plural",  # XXX
    "f inan pl or f anim or f anim pl": "feminine inanimate animate singular plural",  # XXX
    "f anim or f anim pl or f inan": "feminine animate inanimate singular plural",
    "f anim or f anim pl or f inan or f inan pl": "feminine animate inanimate singular plural",
    "m anim pl or f anim pl": "masculine feminine animate plural",
    "m anim pl or f anim pl or f inan or f inan pl": "masculine animate plural feminine inanimate",
    "m anim pl or f anim pl or f inan": "masculine animate feminine plural inanimate singular",  # XXX
    "f anim pl or f inan pl": "feminine animate inanimate plural",
    "f anim pl or f inan pl or m anim pl": "feminine masculine animate inanimate plural",
    "m anim pl or f anim pl or f inan pl": "masculine animate feminine plural inanimate",  # XXX
    "f inan pl or m anim pl": "feminine masculine animate inanimate plural",
    "f inan pl or m anim pl or f anim pl": "masculine animate feminine plural inanimate",  # XXX
    "m anim or f anim or m anim pl": "masculine animate feminine singular plural",
    "m anim or f anim or m anim pl or f anim pl": "masculine animate feminine singular plural",
    "n inan or n anim or m inan or m anim": "neuter inanimate animate masculine",
    "m anim pl or f anim pl or m anim or f anim": "masculine animate plural feminine singular",
    "m anim pl or f inan or f inan pl": "masculine animate plural feminine inanimate singular",  # XXX
    "m anim or n inan": "masculine animate neuter inanimate",  # XXX
    "n inan pl or m inan or m inan pl": "neuter inanimate plural masculine singular plural",  # XXX
    ...
    "f inan or m anim or f anim": "masculine feminine animate inanimate",  # XXX KJ Composite tags??
    "f inan or f inan pl or f anim or f anim pl": "feminine inanimate plural animate",  # XXX
    "m anim or f anim or m anim pl or f anim pl or f inan or f inan pl": "masculine animate feminine plural singular inanimate",  # XXX
...
xlat_tags_map: dict[str, str | list[str]] = {
    "sg": "singular",
    "pl": "plural",
    "sg.": "singular",
    "pl.": "plural",
    ...
    "now sometimes by conflation with etymology 1 under standard German influence": "sometimes",
    "see below": "",
    "unstressed form": "unstressed",
    "mute of": "unstressed form-of",
    "for some speakers": "uncommon",
    'when "do" is unstressed and the next word starts with /j/': "unstressed-before-j",
    ...
    "plural or definite attributive": [
        "plural attributive",
        "definite singular attributive",
    ],
    "plural and definite singular attributive": [
        "plural attributive",
        "definite singular attributive",
    ],
    "oblique and nominative feminine singular": "oblique nominative feminine singular",
    ...
    "(at least) nominative/objective/reflexive cases": "nominative objective",
    ...
    "genitive/dative/instrumental/prepositional": "genitive dative instrumental prepositional",
    ...
    "genitive/accusative/prepositional": "genitive accusative prepositional",
    ...
    "first/declension-2 adjective": "declension-1 declension-2 adjective",
    "first/declension-2 participle": "declension-1 declension-2 participle",
    "class 9/10": "class-9 class-10",
    "class 5/6": "class-5 class-6",
    "class 3/4": "class-3 class-4",
    "class 7/8": "class-7 class-8",
    ...
    "nc 17": "class-17",
    "nc 18": "class-18",
    "cl. 2 to cl. 11 and cl. 16 to cl. 18": "class-2 class-3 class-4 class-5 class-6 class-7 class-8 class-9 class-10 class-11 class-16 class-17 class-18",
    "refl": "reflexive",
    "coll.": "colloquial",
    "colloq.": "colloquial",
    "colloq": "colloquial",
    ...
    "first/second-declension": "declension-1 declension-2",
    "first/declension-2 suffix": "declension-1 declension-2 suffix",
    "first/declension-2 numeral plural only": "declension-1 declension-2 numeral plural-only plural",
    ...
    "nominative and accusative definite singular": "nominative accusative definite singular",
    "not generally used in the plural": "singular-normally",
    "+ genitive": "with-genitive",
    "+ genitive possessive suffix or elative": "with-genitive with-possessive-suffix with-elative",
    "+ genitive-accusative": "with-genitive",
    "genitive + ~": "with-genitive postpositional",
    "+ partitive or (less common) possessive suffix": "with-partitive with-possessive-suffix",
    ...
    "past participle (obsolete except in adjectival use)": "obsolete past participle",
    "short past participle": "past participle short-form",
    "short past adverbial perfective participle": "past adverbial perfective participle short-form",
    "short past adverbial imperfective participle": "past adverbial imperfective participle short-form",
    ...
    "adverbial locative noun in the pa, ku, or mu locative classes": "adverbial locative",
    ...
    "only among women": "",
    "predicate-only": "predicative error-misspelling",  # eleng/Luxembourgish
    ...
    "+ verb in third infinitive illative or adverb": "with-infinitive-iii with-illative with-adverb",
    ...
    "intransitive + inessive or adessive": "intransitive with-inessive with-adessive",
    ...
    "intransitive + partitive or transitive + accusative": "intransitive with-partitive transitive with-accusative",
    "transitive + partitive": "transitive with-partitive",
    "transitive + partitive + essive": "transitive with-partitive with-essive",
    "transitive + elative + kiinni": "transitive with-elative",
    "transitive (+ yllään) + partitive": "transitive with-partitive",
    ...
    "illative + 3rd-person singular": "with-illative with-third-person-singular",
    "partitive + 3rd-person singular": "with-partitive with-third-person-singular",
    ...
    "+ noun phrase] + subjunctive (verb)": "with-noun-phrase with-subjunctive",
    "with noun phrase": "with-noun-phrase",
    "+ [nounphrase] + subjunctive": "with-noun-phrase with-subjunctive",
    "+ number": "with-number",
    ...
    "nominative/vocative/dative/strong genitive": [
        "nominative vocative dative",
        "strong genitive",
    ],
    "non-attributive": "predicative",
    "not predicative": "attributive",
    "attributive use": "attributive",
    "nominative/vocative/instrumental": "nominative vocative instrumental",
    "nominative/vocative/strong genitive/dative": [
        "nominative vocative dative",
        "strong genitive",
    ],
    "nominative/vocative/dative": "nominative vocative dative",
    "accusative/genitive/partitive/illative": "accusative genitive partitive illative",
    "nominative/vocative/accusative/genitive": "nominative vocative accusative genitive",
    "accusative/genitive/locative": "accusative locative genitive",
    "accusative/genitive/dative/instrumental": "accusative genitive dative instrumental",
    ...
    "nominative/genitive/accusative/vocative": "nominative genitive accusative vocative",
    "nominative/genitive/accusative": "nominative genitive accusative",
    "nominative/dative": "nominative dative",
    "nominative/accusative/vocative/instrumental": "nominative accusative vocative instrumental",
    ...
    "first/second/third-person": "first-person second-person third-person",
    ...
    "first-person singular/third-person singular": "first-person third-person singular",
    "first-person singular/third-person plural": [
        "first-person singular",
        "third-person plural",
    ],
    "affirmative/negative": "affirmative negative",
    "first-, second-, third-person singular subjunctive present": "first-person second-person third-person singular subjunctive present",
    "first-, second- and third-person singular present indicative": "first-person second-person third-person singular present indicative",
    ...
    "(yo)": "with-yo",
    "(ele, ela, also used with tu and você?)": "with-ele with-ela with-tu with-você",
    "(eles and elas, also used with vocês and others)": "with-eles with-elas with-vocês with-others",
    "(eles, elas, also used with vocês)": "with-eles with-elas with-vocês",
    "(você)": "with-você",
    "(hiri)": "with-hiri",
    "(hura)": "with-hura",
    "(zuek)": "with-zuek",
    ...
    "(\u00e9l, ella, also used with usted)": "with-él with-ella with-usted",
    "(ellos, ellas, also used with ustedes)": "with-ellos with-ellas with-ustedes",
    ...
    "(ele and ela, also used with você and others)": "with-ele with-ela with-você with-others",
    "(ele, ela, also used with tu and você)": "with-ele with-ela with-tu with-você",
    ...
    "ordinal number corresponding to the cardinal number": "ordinal form-of",
    ...
    "third-person form of the long first infinitive of": "third-person infinitive-i-long form-of",
    ...
    "Switzerland and Liechtenstein standard spelling of": "alt-of Switzerland Liechtenstein standard",
    "form removed with the spelling reform of 2012; superseded by": "alt-of dated",
    ...
    "alternative verbal noun of": "form-of alternative noun-from-verb",
    ...
    "romaji": "Rōmaji",
    "rōmaji": "Rōmaji",
    "visual rendering of Morse code for": "alt-of visual-rendering morse-code",
    "soft mutation of": "form-of mutation-soft",
    "causes soft mutation": "triggers-mutation-soft",
    "non-Oxford British English standard spelling of": "alt-of nonstandard UK",
    ...
    "British and Canada standard spelling of": "alt-of UK Canada standard",
    "Britain and Ireland standard spelling of": "alt-of Britain Ireland standard",
    "Britain and New Zealand standard spelling of": "alt-of Britain New-Zealand standard",
    ...
    "triggers lenition of a following consonant-initial noun": "triggers-lenition",
    ...
    "Medieval and Early Modern Greek regional": "Medieval-Greek Early-Modern-Greek dialectal",
    ...
    "all sects": "",
    "adessive + 3rd person singular + ~": "with-adessive with-third-person-singular postpositional",
    "inessive + 3rd person singular + ~": "with-inessive with-third-person-singular postpositional",
    "~ (olemassa)": "with-olemassa",
    "3rd person singular": "third-person singular",
    "+ genitive + 3rd person singular + passive present participle": "with-genitive with-third-person-singular with-passive-present-participle",
    "genitive + 3rd-pers. singular + 1st infinitive": "with-genitive with-third-person-singular with-infinitive-i",
    "+ direct object in accusative + 3rd infinitive in illative": "transitive with-accusative with-infinitive-iii-illative",
    "+ direct object in accusative + past participle in translative or partitive": "transitive with-accusative with-past-participle-translative with-past-participle-partitive",
    "+ past participle in translative or partitive": "with-past-participle-translative with-past-participle-partitive",
    "active past part. taitanut": "",
    "+ passive past participle in translative": "with-passive-past-participle-translative",
    "+ passive past participle in partitive": "with-passive-past-participle-partitive",
    "+ active past participle in translative": "with-past-participle-translative",
    "+ adjective in ablative or allative": "with-adjective with-ablative with-allative",
    "in indicative or conditional mood": "in-indicative in-conditional",
    ...
    "no third-person singular past historic": "no-third-person-singular-past-historic",
    ...
    "no first-person singular past historic": "no-first-person-singular-past-historic",
    "no definite forms": "no-definite",
    "no definite form": "no-definite",
    "no diminutive": "no-diminutive",
    "no second-person singular imperative": "no-second-person-singular-imperative",
    ...
    "+ optionally: adjective in accusative case + neuter noun in accusative case": "definite neuter with-accusative",
    ...
    "combined with me": "object-first-person object-singular",  # tergiver/Spanish
    "combined with te": "object-second-person object-singular",  # tergiver/Spanish
    "combined with le": "object-third-person object-singular dative",  # tergiver/Spanish
    ...
    "combined with les": "object-third-person object-plural dative",  # tergiver/Spanish
    "combined with lo": "object-third-person object-singular object-masculine accusative",
    "combined with la": "object-third-person object-singular object-feminine accusative",
    "combined with los": "object-third-person object-plural object-masculine accusative",
    "combined with las": "object-third-person object-plural object-feminine accusative",
    "class m-wa": "class-1 class-2",
    "class m-mi": "class-3 class-4",
    "class ma": "class-5 class-6",
    "class ki-vi": "class-7 class-8",
...
xlat_descs_map = {
    ...
    "+ location in inessive, adessive + vehicle in elative, often with pois": "with-inessive with-adessive with-elative",
    "+ accusative +, Genitive": "with-accusative with-genitive",
    "with genitive, instrumental or dative case": "with-genitive with-instrumental with-dative",
    "+ illative, allative, (verbs) 3rd infinitive in illative": "with-illative with-allative with-infinitive-iii-illative",
    "(inessive or adessive) + 3rd-pers. sg. + an adverb": "with-inessive with-adessive with-third-person-singular with-adverb",
    "+ partitive for agent, + allative for target": "with-partitive with-allative",
    "+ infinitive; in indicative or conditional mood": "with-infinitive with-indicative with-conditional",
    "transitive, auxiliary + first infinitive, active past part. taitanut or tainnut": "transitive, auxiliary, with-infinitive-i",
    "elative + 3rd person singular + noun/adjective in nominative or partitive or personal + translative": "with-elative with-third-person-singular",  # XXX very incomplete
    "group theory, of a group, semigroup, etc.": "group theory",
    "Triggers lenition of b, c, f, g, m, p, s. Triggers eclipsis of d, t.": "triggers-lenition triggers-eclipsis",
    ...
    "for = elative; for verbs action noun in elative": "with-action-noun-in-elative",
    # de/Danish
...
for k, v in valid_tags.items():
    ...
    if v not in tag_categories:
        print(
            "valid_tags[{!r}]={!r} - {!r} not in tag_categories!".format(
                k, v, v
            )
        )
