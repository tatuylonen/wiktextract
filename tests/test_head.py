...
class HeadTests(unittest.TestCase):
    ...
    def test_reconstruction1(self):
        data = {}
        self.wtpctx.start_page("Reconstruction:Proto-Germanic/testpage")
        self.wtpctx.start_section("Proto-Germanic")
        parse_word_head(self.wtpctx, "noun", "*testpage", data, True, None)
    ...
    def test_reconstruction2(self):
        ...
        self.wtpctx.start_page("Reconstruction:Proto-Germanic/testpage")
        self.wtpctx.start_section("Proto-Germanic")
        parse_word_head(self.wtpctx, "noun", "*testfoo", data, True, None)
        self.assertEqual(self.wtpctx.errors, [])
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
    ...
    def test_reconstruction3(self):
        data = {}
        parse_word_head(self.wtpctx, "noun", "*testpage", data, False, None)
        self.assertEqual(data, {"forms": [{"form": "*testpage",
                                           "tags": ["canonical"]}]})

    def test_head1(self):
        data = {}
        parse_word_head(self.wtpctx, "noun", "", data, False, None)
        self.assertEqual(self.wtpctx.errors, [])
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
        self.assertEqual(data, {})
    ...
    def test_head4(self):
        data = {}
        parse_word_head(self.wtpctx, "noun", "testpage f", data, False, None)
        self.assertEqual(self.wtpctx.errors, [])
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
    ...
    def test_head5(self):
        data = {}
        parse_word_head(self.wtpctx, "noun", "testpAge m", data, False, None)
        self.assertEqual(self.wtpctx.errors, [])
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
    ...
    def test_head6(self):
        data = {}
        parse_word_head(self.wtpctx, "noun", "testpage n", data, False, None)
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
    ...
    def test_head7(self):
        data = {}
        parse_word_head(self.wtpctx, "noun", "testpage c", data, False, None)
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
    ...
    def test_head8(self):
        data = {}
        self.wtpctx.start_section("Zulu")
        parse_word_head(self.wtpctx, "noun", "testpage 1", data, False, None)
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
    ...
    def test_head8b(self):
        ...
        self.assertEqual(self.wtpctx.errors, [])
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertNotEqual(self.wtpctx.debugs, [])
        self.assertEqual(data, {"forms": [{"form": "testpage 1",
                                           "tags": ["canonical"]}]})

    def test_head9(self):
        data = {}
        parse_word_head(self.wtpctx, "noun",
    ...
    def test_head17(self):
        data = {}
        self.wtpctx.start_page("index")
        self.wtpctx.start_section("English")
        self.wtpctx.start_subsection("Noun")
        parse_word_head(self.wtpctx, "noun",
                        "index n",
                        data, False, None)
        self.assertEqual(self.wtpctx.warnings, [])
    ...
    def test_head19(self):
        ...
        self.wtpctx.start_section("English")
        self.wtpctx.start_subsection("Noun")
        parse_word_head(self.wtpctx, "noun", "foo f or bar m", data, False, None)
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
        self.assertEqual(data, {"forms": [
    ...
    def test_head20(self):
        ...
        self.wtpctx.start_section("English")
        self.wtpctx.start_subsection("Noun")
        parse_word_head(self.wtpctx, "noun", "foo or bar", data, False, None)
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
        self.assertEqual(data, {"forms": [
            {"form": "foo", "tags": ["canonical"]},
    ...
    def test_head21(self):
        ...
        self.wtpctx.start_section("English")
        self.wtpctx.start_subsection("Noun")
        parse_word_head(self.wtpctx, "noun", "foo f or n or bar m or c", data,
                        False, None)
        self.assertEqual(self.wtpctx.warnings, [])
        self.assertEqual(self.wtpctx.debugs, [])
        self.assertEqual(data, {"forms": [
    ...
    def test_head23(self):
        data = {}
        self.wtpctx.start_page("indubitables")
        self.wtpctx.start_section("English")
        self.wtpctx.start_subsection("Adjective")
        parse_word_head(self.wtpctx, "adj", "indubitables m pl or f pl", data,
                        False, None)
    ...
    def test_head24(self):
        ...
        self.wtpctx.start_section("Japanese")
        self.wtpctx.start_subsection("Noun")
        parse_word_head(self.wtpctx, "noun",
                        "foo (12 strokes)",
                        data, False, None)
    ...
    def test_head27(self):
        data = {}
        self.wtpctx.start_page("أَبْلَعَ")
        self.wtpctx.start_section("Arabic")
        self.wtpctx.start_subsection("Verb")
        parse_word_head(self.wtpctx, "verb",
    ...
    def test_head32(self):
        data = {}
        self.maxDiff = 10000
        self.wtpctx.start_page("rive")
        self.wtpctx.start_section("Danish")
        self.wtpctx.start_subsection("Noun")
        parse_word_head(self.wtpctx, "noun",
    ...
    def test_head33(self):
        data = {}
        self.maxDiff = 10000
        self.wtpctx.start_page("rear admiral (lower half)")
        self.wtpctx.start_section("English")
        self.wtpctx.start_subsection("Noun")
        parse_word_head(self.wtpctx, "noun",
