    ...
    def test_ru_extract_gloss(self):
        ...
        test_cases = [
            # Cleans examples from gloss and raw_glosses
            {
                ...
                "expected": {
                    "raw_glosses": ["съедобная часть овоща [1]"],
            ...
            # Extracts tags
            {
                ...
                "expected": {
                    ...
                    "glosses": ["бесхарактерный, безвольный человек, лишённый активной жизненной позиции"],
                    "raw_glosses": ["разг., неодобр. или пренебр. бесхарактерный, безвольный человек, лишённый активной жизненной позиции"],
                },
            },
            # Extracts notes
            {
                ...
                "expected": {
                    "notes": ["часто мн. ч."],
                    "glosses": ["обобщающее название растительной пищи, не включающей фрукты и крупы"],
                    "raw_glosses": ["часто мн. ч. обобщающее название растительной пищи, не включающей фрукты и крупы"],
                },
            },
        ]
