...
* форма творительного падежа множественного числа  местоимения&#32;''[[они#Русский|они]]''[[Категория:Формы местоимений/ru]][[Категория:Формы местоимений/ru]][[Категория:Словоформы/ru]]""",  # noqa: E501
        )
        self.assertEqual(
            parse_page(
                self.wxr,
