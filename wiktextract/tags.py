...
xlat_head_map = {
    ...
    "f inan or m anim or f anim":
        "masculine feminine animate inanimate",  #XXX KJ Composite tags??
    "f inan or f inan pl or f anim or f anim pl":
...
uppercase_tags = set([
    ...
    "San Pedro Amuzgos",
    "Ajaccino",
    "Alupec",  #Nonstandard lower-case of ALUPEC, just in case it pops up again.
    "Ancient Cretan",
    "Arbërëshë Albanian",
    "Arbërëshë",
    "Arebica",
    ...
    "High Saxonian",
    "High Sorbian",
    "Hill",  # Hill Mari, Meadow Mari, dandruff/English
    "Meadow",
    "Hochpreußisch",
    "Hoisanese",
    "Huallaga",
    ...
    "Isthmus",
    "Jewish Babylonian",
    "Jewish Northeastern Neo-Aramaic",
    "Judeo-Malayalam",
    "Kagwahiv",
    "Kaigani",
    "Kaili",
    ...
    "Tabarchino",
    "Tarashkevitsa",
    "Tataltepec Coastal Chatino",
    "Terengganu Malay",
    "Town Frisian",
    "Tuscan dialect",
    "UEY",  # Uyghyr, wash/English
    "USY",  # Uyghyr ^
